      ...
      <div className="bg-blue-950  text-center text-white">
        <article className="phonemax:px-16 grid grid-flow-row grid-cols-1 gap-5 mx-16 phonemax:grid-rows-8 justify-center items-center tabletmax:grid-cols-2 tabletmax:grid-rows-4 ">
          ...
          <div> 
            ...
            <p className="phonemin:text-m px-12 tabletmin:text-2xl font-thin">The premier destination for LaserDisc collectors and enthusiasts. Our passion for the classic, the rare, and the nostalgic is at the heart of everything we do. We believe that every LaserDisc tells a story, and we are here to help you find those rare gems that complete your collection.</p>
          </div>
          ...
          <div>
            ...
            <p className="phonemin:text-m px-12 tabletmin:text-2xl font-thin">At <span>Laser Focus</span>, we are more than just an online store; we are a community of like-minded individuals who share a deep appreciation for the artistry and nostalgia of LaserDiscs. Connect with us on social media, join our mailing list for exclusive updates, and become part of a vibrant community that celebrates the beauty of collecting rare items.</p>
          </div>
